	...
	public static final void checkDonation(final Player player) {
		...
		CoresManager.slowExecutor.execute(new Runnable() {
			...
			public void run() {
				try {
					URL url = new URL(
							"http://.com/donate/checkdonate.php?username="
 ...
 * public class Donations {
 * 
 * private static final String HOST = "rsps.com"; private static final
 * String LOGIN = "donations@rsps.com"; private static final String
